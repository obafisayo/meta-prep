...
export const WEEKS = [
  {
    ...
    weekday: ["Two Sum", "Contains Duplicate", "Valid Anagram", "🕰️ Number of Islands (Amazon)", "Top K Frequent Elements"],
    sat: "Product of Array Except Self + re-solve Merge Intervals",
    milestone: "Upskill Challenge days 0–2 + 45-min Amazon Leadership Principles read",
  },
  {
    theme: "Ch.4 Disks & Filesystems",
    linux: "Partitions, mounting, fstab, inodes. Lab: loop device → mkfs → fill → fsck",
    weekday: ["Valid Palindrome", "Two Sum II", "Container With Most Water", "🕰️ Longest Substring Without Repeating (Amazon)", "Best Time to Buy and Sell Stock"],
  ...
  },
  {
    ...
    weekday: ["Valid Parentheses", "Daily Temperatures", "Binary Search", "🕰️ Rotting Oranges (Amazon — grid BFS)", "Search a 2D Matrix"],
  ...
  },
  {
    ...
    weekday: ["Reverse Linked List", "Merge Two Sorted Lists", "Reorder Log Files", "🕰️ Merge K Sorted Lists (Amazon)", "String to Integer (atoi)"],
    sat: "Build a log-line parser from scratch + re-solve Daily Temperatures",
    milestone: "Upskill Challenge days 13–17 (🕰️ LRU Cache lands in Wk 8)",
  },
  {
    ...
    milestone: "Start A Tour of Go · Mondays: check Meta Careers + Amazon OA inbox",
  },
  {
  ...
  },
  {
    ...
    weekday: ["Kth Largest in a Stream", "Go project — ship it", "Last Stone Weight", "🕰️ K Closest Points to Origin (Amazon)", "APPLY if posting is live"],
  ...
  },
  {
    ...
    weekday: ["Timed: 2 problems / 45 min", "Glassdoor + Blind recon", "Timed: 2 in 45 min (incl. 🕰️ LRU Cache)", "Timed: 2 in 45 min (incl. 🕰️ Reorganize String)", "Glassdoor + Blind recon"],
